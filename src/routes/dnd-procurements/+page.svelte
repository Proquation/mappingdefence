...
<main class="page">
	<TitleStandard title="How is the Department of National Defence procuring goods and services?" />
	<div class="text">
		<AuthorDate
		...
		/>
		<p>
            This page goes over the nature and geography of DND's defence procurement.
		</p>
	</div>
